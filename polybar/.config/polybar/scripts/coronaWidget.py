...
with urllib.request.urlopen(
    f"https://public.opendatasoft.com/api/records/1.0/search/?dataset=covid-19-germany-landkreise&q=freiburg&sort=-cases_per_population&facet=last_update&facet=name&facet=rs&facet=bez&facet=bl"
) as response:
...
number = json_response["records"][0]["fields"]["cases7_lk"]
